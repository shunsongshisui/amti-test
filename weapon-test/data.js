/* =====================================================================
   ...
   模型：7 维战斗气质（刚猛/迅捷/精准/射程/灵动/坚韧/时代），各 0–100。
     题库两种题型（情境量表 likert / 二选一快答 forced）× 三档题量（42 / 56 / 70，
     每维 6 / 8 / 10 题，含反向题），答案映射为"理想武器画像"，
...
window.WEAPON_DATA = {
  ...
  /* ---------- 题库（两种题型 × 三档题量） ----------
     likert : 5 档情境量表。每维 10 题，前 6 题供 42 题版、前 8 题供 56 题版、
              前 10 题供 70 题版；含反向题（dir:'-'，同意压低该维）。题面全部"隐晦化"：
              情境式描述，不出现"刚猛/迅捷"等维度字面，看不出哪个答案更好。
     forced : 二选一快答。每维 10 题，dir:'h' = 选 A 推高该维；dir:'l' = 选 A 压低该维。
  ...
  */
  questions: {
    likert: [
      ...
      { id: 'p9', dim: 'power', dir: '-', text: '有人跟我抬杠时，我多半笑笑让过去，不值得为口气较劲。' },
      { id: 'p10', dim: 'power', text: '越是撞见难啃的骨头，我越想亲自动手把它啃下来。' },
      // ===== 迅捷 =====
      ...
      { id: 's9', dim: 'speed', dir: '-', text: '赶路也好、赶工也好，我宁可早点出发慢慢走，也不愿一路狂奔。' },
      { id: 's10', dim: 'speed', text: '听说哪里出了新鲜事，我常常是第一个赶到现场的人。' },
      // ===== 精准 =====
      ...
      { id: 'c9', dim: 'precision', dir: '-', text: '房间乱一点、错字漏几个，我不会专门去管，不影响大局就行。' },
      { id: 'c10', dim: 'precision', text: '同样一道题，别人给个大概答案，我会忍不住把过程也算给他看。' },
      // ===== 射程 =====
      ...
      { id: 'r9', dim: 'range', dir: '-', text: '我信一回生二回熟，处得近，才能摸清一个人的底细。' },
      { id: 'r10', dim: 'range', text: '站在高处往下看，我从不觉得眩晕，反而觉得整片局势都在眼底。' },
      // ===== 灵动 =====
      ...
      { id: 'm9', dim: 'mobility', dir: '-', text: '换到新环境、新路线，我头几天会特别不适应。' },
      { id: 'm10', dim: 'mobility', text: '朋友聚会临时改地方，我第一个说走就走，新路线心里早就有数。' },
      // ===== 坚韧 =====
      ...
      { id: 't9', dim: 'toughness', dir: '-', text: '辛苦日子过得久了，我也会偷偷盼着有人能替我扛一阵。' },
      { id: 't10', dim: 'toughness', text: '别人都喊累的时候，我还能若无其事地接着把事情做完。' },
      // ===== 时代 =====
      ...
      { id: 'e9', dim: 'era', dir: '-', text: '比起新款设备的参数，我更愿意信老物件经年累月攒下的口碑。' },
      { id: 'e10', dim: 'era', text: '机器能算的，我就不想自己手算，把活交给工具，天经地义。' }
    ],
    ...
    forced: [
      ...
      { id: 'pf9', dim: 'power', type: 'forced', dir: 'h', a: '推不动，我加把劲再推', b: '推不动，就绕开它' },
      { id: 'pf10', dim: 'power', type: 'forced', dir: 'l', a: '稳住比逞强要紧', b: '场面不能输，硬撑也要撑' },
      // ===== 迅捷 =====
      ...
      { id: 'sf9', dim: 'speed', type: 'forced', dir: 'h', a: '消息没回完，我睡不踏实', b: '明天回也一样' },
      { id: 'sf10', dim: 'speed', type: 'forced', dir: 'l', a: '慢慢来，反正也不急', b: '能快就快，别磨蹭' },
      // ===== 精准 =====
      ...
      { id: 'cf9', dim: 'precision', type: 'forced', dir: 'h', a: '报告里连标点都要检查', b: '意思对了就行' },
      { id: 'cf10', dim: 'precision', type: 'forced', dir: 'l', a: '拍脑袋给个数也行', b: '数据得对上账' },
      // ===== 射程 =====
      ...
      { id: 'rf9', dim: 'range', type: 'forced', dir: 'h', a: '坐得远一点，看得全', b: '坐得近一点，插得上话' },
      { id: 'rf10', dim: 'range', type: 'forced', dir: 'l', a: '离得近，人心才热', b: '保持距离，各自清爽' },
      // ===== 灵动 =====
      ...
      { id: 'mf9', dim: 'mobility', type: 'forced', dir: 'h', a: '车头一拐，我马上跟', b: '走错路我也将就到底' },
      { id: 'mf10', dim: 'mobility', type: 'forced', dir: 'l', a: '一件事定了就做完它', b: '干着干着我又换主意' },
      // ===== 坚韧 =====
      ...
      { id: 'tf9', dim: 'toughness', type: 'forced', dir: 'h', a: '心里再堵，第二天照常出门', b: '缓过来再说，谁也别催' },
      { id: 'tf10', dim: 'toughness', type: 'forced', dir: 'l', a: '事情难，我先喘口气', b: '越难越不能停' },
      // ===== 时代 =====
      ...
      { id: 'ef9', dim: 'era', type: 'forced', dir: 'h', a: '新工具再难，也值得学', b: '老办法用得顺手就行' },
      { id: 'ef10', dim: 'era', type: 'forced', dir: 'l', a: '菜单上新菜，我先点招牌老味道', b: '新菜先试一口，不好再换' }
    ]
  },
